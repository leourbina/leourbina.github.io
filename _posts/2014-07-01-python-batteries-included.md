...
Starting with with version 3.3, Python now ships with pip and its own implementation of virtual environments. Creating a new virtual environment is as easy as
